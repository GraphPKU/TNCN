...
def train():
    ...
    for batch in tqdm(train_loader):
        ...
        pos_out = model['link_pred'](pos_z1[src_re], pos_z1[pos_re])
        ...
        neg_out = model['link_pred'](neg_z1[nsrc_re], neg_z1[neg_re])
...
def test(loader, neg_sampler: NegativeEdgeSampler, split_mode):
    ...
    for idx, pos_batch in enumerate(tqdm(loader)):
        ...
        pos_pred = model['link_pred'](pos_z1[src_re], pos_z1[pos_re])
        ...
        neg_pred = model['link_pred'](neg_z1[nsrc_re], neg_z1[neg_re])
